...
- Each published `Areas/` note stays `Needs Review` until its own claims are checked. Metadata conversion alone never promotes it.
...
- [[Taxonomy Leaf Extension Register|Taxonomy Leaf Extension Register]]
