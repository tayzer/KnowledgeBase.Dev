...
A Task can represent I/O waiting without occupying a worker. Default Task Parallel Library scheduling commonly uses pool workers for delegate execution. Diagnose starvation using pool metrics and blocked stacks before changing thread limits; bound CPU work to useful capacity.
...
- [Primary documentation](https://learn.microsoft.com/en-us/dotnet/standard/threading/the-managed-thread-pool) (accessed 2026-09-24).
