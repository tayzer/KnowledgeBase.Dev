...
- Caution: **Read-only is not immutable**: `IReadOnlyList<T>` can still wrap mutable backing state.
- Caution: **Collection choice affects performance** through allocation, locality, hashing, resizing, and enumeration behavior.
...
Arrays and List<T> offer indexed contiguous storage; Dictionary and HashSet rely on correct equality and hashing; LinkedList is useful when callers already hold nodes and repeatedly insert around them. Performance descriptions are typical, not guarantees. Keep detailed APIs in the dedicated List, Dictionary, and HashSet notes.
...
- [Primary documentation](https://learn.microsoft.com/en-us/dotnet/standard/collections/) (accessed 2026-09-24; check version at source).

- [Microsoft Docs: Collections in .NET](https://learn.microsoft.com/en-us/dotnet/standard/collections/)
- [Microsoft Docs: Choosing between collection classes](https://learn.microsoft.com/en-us/dotnet/standard/collections/selecting-a-collection-class)
