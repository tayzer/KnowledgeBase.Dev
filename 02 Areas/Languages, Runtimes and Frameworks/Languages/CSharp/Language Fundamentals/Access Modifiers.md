...
- Caution: **Overexposed members increase coupling** and make refactoring harder.
...
Default accessibility depends on declaration context: top-level types default to internal and class members to private. The file modifier applies to top-level types and limits the name to one source file. InternalsVisibleTo can grant named friend assemblies access to internal APIs; it does not make those APIs public. Explicit accessibility helps state an intended boundary.
...
- [Primary documentation](https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/access-modifiers) (accessed 2026-09-24; check version at source).
