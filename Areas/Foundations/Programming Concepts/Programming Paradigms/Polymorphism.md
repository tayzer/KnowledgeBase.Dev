...
- ✅ Enables the [[Areas/Engineering Practice/Code Design and Construction/Open-Closed Principle|OCP]] – add new types without modifying existing code.
- ✅ [[Areas/Engineering Practice/Code Design and Construction/Liskov Substitution Principle|LSP]] guarantees that derived types can safely substitute base types.
...
- [[Areas/Engineering Practice/Code Design and Construction/SOLID Principles]] – Polymorphism enables OCP, LSP, and DIP.
- [[Areas/Application Development/Backend Engineering/Dependency Injection]] – Leverages polymorphism to inject different implementations.
