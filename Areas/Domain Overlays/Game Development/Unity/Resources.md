...
Date: 2026-04-30
Status: 🟡 Needs Review
Tags: #unity #resources #gamedev #learning
...
- ⚠️ **Resource notes need pruning:** keep only references that are still useful and relevant.
...
### ECS / DOTS
- [Unity Entities samples: Jobs example](https://github.com/Unity-Technologies/EntityComponentSystemSamples/blob/master/EntitiesSamples/Assets/ExampleCode/Jobs.cs)
- [Unity DOTS samples repository](https://github.com/Unity-Technologies/EntityComponentSystemSamples?tab=readme-ov-file)

### Procedural Generation
- [Catlike Coding maze tutorial](https://catlikecoding.com/unity/tutorials/prototypes/maze-2/)
