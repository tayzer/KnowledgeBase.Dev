...
## 🔗 Related Concepts
- [[Areas/Languages, Runtimes and Frameworks/Languages/CSharp/Generics/Generic Constraints]] - LINQ relies heavily on generics.
- [[Areas/Languages, Runtimes and Frameworks/Languages/CSharp/Language Fundamentals/Delegates, Events, and Actions]] - `Func<T, bool>` predicates are the backbone of LINQ.
- [[Areas/Languages, Runtimes and Frameworks/Languages/CSharp/Language Fundamentals/Expression-Bodied Members]] - Often used with LINQ selectors.
- [[Areas/Languages, Runtimes and Frameworks/Languages/CSharp/Type System/Collection Types]] - Source collection choice affects evaluation, materialization, and performance.
