...
Date: 2026-06-16
Status: 🟡 Needs Review
Tags: #engineering-approach #workflow #architecture #quality

## 🎯 TL;DR / Quick Reference

**Definition:** Cross-cutting development approaches that shape how teams design, validate, and evolve software.
...
- ⚠️ Avoid duplicating full notes across multiple categories.
...
- [[Areas/Architecture and Patterns/Domain-Driven Design/Domain-Driven Design|Domain-Driven Design]] - Domain modeling approach for aligning software with business capabilities.
- [[Fitness-Function Driven Development]] - Evolutionary architecture approach with executable architectural constraints.
